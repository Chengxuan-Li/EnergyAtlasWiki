...
See the [Enums Reference](../library/enums.md) for all enum value sets used by the fields in this document.
...
| Property Key | Type | Unit | Default | Description |
|---|---|---:|---|---|
| `DOEBuildingType` | `DOEBuildingType` | — | `UNDEFINED` | Building program / archetype selector. See [`DOEBuildingType`](../library/enums.md#doebuildingtype). |
...
Enum values: see [GlazingOptions](../library/enums.md#glazingoptions) and [CapacityClass](../library/enums.md#capacityclass).
...
Enum values: see [SystemOptions](../library/enums.md#systemoptions) and [Fuel](../library/enums.md#fuel).
...
Enum values: see [Fuel](../library/enums.md#fuel).
