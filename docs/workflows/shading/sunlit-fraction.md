...
- [Python reference: `voxel_shading.calculate`](../../python/index.md#voxel_shading)
- [Web reference: `POST /api/voxelShading/calculate`](../../web-api/index.md#controller-endpoint-inventory)
