...
**Access**: Check updates via [EnergyAtlas.io](http://EnergyAtlas.io/)
...
**Status**: The Windows app is currently under development. Check [EnergyAtlas.io](http://EnergyAtlas.io/) for updates.

**Internal Release**: Test our [internal release version]()

### MacOS

**Status**: The MacOS app is currently under development. Check [EnergyAtlas.io](http://EnergyAtlas.io/) for updates.
...
**Status**: The Rhinoceros/Grasshopper plugin is currently under development. Check [EnergyAtlas.io](http://EnergyAtlas.io/) for updates.
...
**Status**: The QGIS plugin is currently under development. Check [EnergyAtlas.io](http://EnergyAtlas.io/) for updates.
...
```bash
pip install energyatlas [not yet available on pip]
```

**Status**: The Python package is currently under development. Check [EnergyAtlas.io](http://EnergyAtlas.io/) for updates.
...
**Status**: The public API is currently under development. Check [EnergyAtlas.io](http://EnergyAtlas.io/) for updates.
