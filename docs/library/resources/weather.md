...
- [Weather File Object](../objects/weather-file.md) - Weather file structure
- [Running and Calibrating Workflow](../../workflows/gui/running-calibrating.md) - Using weather data
- [Input Output Guide](../../workflows/input-output.md) - File formats
