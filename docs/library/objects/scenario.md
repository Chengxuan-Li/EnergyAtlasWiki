...
- [Scenario Design Workflow](../../workflows/gui/scenario-design-simulation.md) - Creating scenarios
- [Retrofit Measures Library](../resources/retrofit-measures.md) - Available measures
