...
**See**: [Archetype Object](archetype.md)
...
**See**: [Archetype Assignment Rule Object](archetype-assignment-rule.md)
...
**See**: [Geospatial Data Object](geospatial-data.md)
...
**See**: [Weather File Object](weather-file.md)
...
**See**: [Retrofit Measure Object](retrofit-measure.md)
...
**See**: [Scenario Object](scenario.md)
...
- [Workflows Guide](../../workflows/index.md) - Using objects in workflows
- [Input Output Guide](../../workflows/input-output.md) - Object data formats
- [Data Preparation](../../workflows/data-prep.md) - Preparing data for objects

## Individual Object References

- [Datahub](datahub.md) - Central data repository
- [Archetype](archetype.md) - Building archetype definitions
- [Archetype Assignment Rule](archetype-assignment-rule.md) - Assignment rules
- [Geospatial Data](geospatial-data.md) - Geographic data entries
- [Weather File](weather-file.md) - Weather data files
- [Retrofit Measure](retrofit-measure.md) - Energy efficiency measures
- [Scenario](scenario.md) - Retrofit scenarios
